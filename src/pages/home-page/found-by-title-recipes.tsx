...
// import { BestCard } from './sections/best-recipes/best-recipes-list/components/best-card'; // карточка рецепта
// import { BestCardSmall } from './sections/best-recipes/best-recipes-list/components/best-small-card';

// interface FoundByTitleRecipesListProps {
//     searchText: string;
// }
// export const FoundbyTitleRecipesList: React.FC<FoundByTitleRecipesListProps> = ({ searchText }) => {

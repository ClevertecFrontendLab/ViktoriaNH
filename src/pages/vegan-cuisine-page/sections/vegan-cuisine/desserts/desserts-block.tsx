...
export interface DessertsBlockProps {
    data: {
        id: number;
        title: string;
        category: string;
...
export const DessertsBlock = ({ data }: DessertsBlockProps) => {
    ...
    return (
        <Card
            ...
            boxShadow='none'
            p={{ base: '14px 12px', lg: '12px', xl: '14.6px 24px' }}
            h={{ sm: '52px', md: '48px', lg: '52px', xl: '57.3px' }}
        >
            <CardBody display='flex' alignItems='end' p={0} bg='white'>
                <Box display='flex' alignItems='center' w='100%' mt='-5px' minW={0}>
                    <Box display='flex' alignItems='center' gap='8px' flex='1 1 auto' minW={0}>
                        ...
                        <Text
                            ...
                            lineHeight={{ base: '24px', lg: '233.33%', xl: '233.33%' }}
                            isTruncated
                            whiteSpace='nowrap'
                            overflow='hidden'
